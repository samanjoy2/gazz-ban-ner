...
process_data("dev2022main.txt", "processed_dev2022.jsonl")
process_data("train2022main.txt", "processed_train2022.jsonl")
process_data("test2022main.txt", "processed_test2022.jsonl")
